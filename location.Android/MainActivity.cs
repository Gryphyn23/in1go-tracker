...
{
	[Activity (Label = "in1go Tracker", MainLauncher = true)]
    ...
    public class DeviceIMEI
    {
        ...
        public static string GetDeviceId(Android.Content.Context context)
        {
            ...
            {
                Android.Telephony.TelephonyManager telephonyMgr = context.GetSystemService(Android.Content.Context.TelephonyService) as Android.Telephony.TelephonyManager;

                deviceID = telephonyMgr.DeviceId == null ? "UNAVAILABLE" : telephonyMgr.DeviceId;
                //deviceID = telephonyMgr.Line1Number == null ? "UNAVAILABLE" : telephonyMgr.Line1Number;
